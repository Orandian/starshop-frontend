...
interface SupplierOrderFilterProps {
  onFilter: (filters: {
    brandName: string;
    productName: string;
    status: string;
...
export const SupplierOrderFilter: React.FC<SupplierOrderFilterProps> = ({
  onFilter,
  initialFilters = {
    brandName: "",
    productName: "",
  ...
  return (
    <div className="content-card bg-white border border-gray-200 rounded-lg p-6 my-4">
      <div className="flex justify-between items-center gap-4 flex-col md:flex-row">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 mb-3 w-full">
          {/* ブランド名 */}
