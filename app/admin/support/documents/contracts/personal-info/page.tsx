...
const FCPersonalInfoPage = () => {
  ...
  const companyInfo = {
    ...
    openingDuration: "平日 10:00～17:00 "
  };
      ...
      <div className="w-full px-8 py-2 bg-white card-border border-0 rounded-[10px] shadow-[0_0_15px_0_rgba(0,0,0,0.1)] h-auto">
        ...
        >
          ...
          <div className="space-y-6">
            ...
            <p className={pClass}>
              ビューテック株式会社（以下、「当社」といいます）は、当社が運営する化粧品販売ECサイト（以下、「本サービス」）において、お客様の個人情報の適切な取扱いと保護に努めます。
            </p>
            <ol className={`ml-4 ${liHeaderClass}`}>
              ...
              <li className="mb-2">
                6. 開示・訂正・削除等の請求について
                <p className={`font-normal ${pClass}`}>
                  お客様ご本人から、当社が保有する個人情報の開示、訂正、利用停止、削除等p希望される場合は、当社所定の手続きに基づき、適切に対応いたします。
                </p>
              </li>
              {/* No.7 */}
              <li className="mb-2">
                ...
                <ul className={`ml-4 font-normal ${pClass}`}>
                  ...
                  <li>※受付時間：{companyInfo.openingDuration}</li>
                </ul>
              </li>
              {/* No.8 */}
              <li>
