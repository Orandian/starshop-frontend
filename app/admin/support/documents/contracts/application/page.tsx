...
import { FCMasterPlan } from "@/types/fc/plan.type";
  ...
  const mockUserDetail = {
    data: {
      ...
      tantoPosition: "営業部長",
      tantoName: "山田 太郎",
      contractStartDt: [2024, 1, 1],
      contractEndDt: [2024, 12, 31],
      contractUpdateFlg: "有",
      contractPlan: {
        fcPlanMasterId: 1,
        introIncentive: 50000
      },
      depositType: "",
      deposite: null,
      referrerId: null,
      contSupplySalesAggree: 1,
      signPath: "mock-signature"
    }
  };
 
  const mockReferralUserDetail = {
    data: {
      user: {
        username: "鈴木 一郎",
        userId: "67890"
...
const FCApplicationPage = () => {
  ...
  const [filteredPlans] = useState<FCMasterPlan[]>([]);
  ...
  return (
    <section className="w-full flex justify-center">
      <div className="w-full px-8 py-2 bg-white card-border border-0 rounded-[10px] shadow-[0_0_15px_0_rgba(0,0,0,0.1)] h-auto">
        {/* Download Button */}
        ...
        >
          <p className="text-xs">BEAUTECH株式会社</p>
              ...
              <tbody>
                ...
                <tr className={tableClass}>
                  ...
                  >
                    ...
                    {mockUserDetail?.data?.user?.usernameKana || "-"}
                  </td>
                </tr>
                <tr className={tableClass}>
                  {/* company name */}
                  ...
                  >
                    ...
                    {mockUserDetail?.data?.user?.username || "-"}
                  </td>
                </tr>
                <tr className={tableClass}>
                  {/* address */}
                ...
                <tr className={tableClass}>
                  ...
                  <td
                    ...
                    colSpan={3}
                  >
                    {mockUserDetail?.data?.representativeName || "-"}
                  </td>
                </tr>
                <tr className={tableClass}>
                  <td
                ...
                <tr className={tableClass}>
                  ...
                  <td className={[tableClass, borderDownClass].join(" ")}>
                    {mockUserDetail?.data?.tantoPosition || "-"}
                  </td>
                  {/* name */}
                  <td
                    className={[
                ...
                <tr className={tableClass}>
                  ...
                  <td className={[tableClass, borderDownClass].join(" ")}>
                    {mockUserDetail?.data?.user?.phoneNumber || "-"}
                  </td>
                  {/* mail */}
                  <td
                    className={[
                  ...
                  <td className={[tableClass, borderDownClass].join(" ")}>
                    {mockUserDetail?.data?.user?.email || "-"}
                  </td>
                </tr>
                <tr className={tableClass}>
                  <td
                ...
                <tr className={tableClass}>
                  ...
                  <td className={tableClass}>
                    <input
                      ...
                      checked={mockUserDetail?.data?.contSupplySalesAggree === 1}
                      disabled
                      readOnly
                    />
                  </td>
          ...
          <div className="space-y-4">
            ...
            >
              <tbody>
                ...
                <tr className={tableClass}>
                  ...
                  >
                    ...
                    {userDetail?.data?.contractEndDt[2]}日 */}
                      ...
                      {mockUserDetail?.data?.contractStartDt[0]}年
                    {mockUserDetail?.data?.contractStartDt[1]}月
                    {mockUserDetail?.data?.contractStartDt[2]}日 〜{" "}
                    {mockUserDetail?.data?.contractEndDt[0]}年
                    {mockUserDetail?.data?.contractEndDt[1]}月
                    {mockUserDetail?.data?.contractEndDt[2]}日
                  </td>
                </tr>
                <tr>
                  <td
                  ...
                  <td className={`pl-2 ${borderDownClass}`}>
                    <div className="flex items-center">
                      <input
                        ...
                        className={checkboxClass}
                        checked={mockUserDetail?.data?.contractUpdateFlg === "有"}
                        disabled
                        readOnly
                      />
                      <label
                  ...
                  >
                    <div className="flex items-center">
                      <input
                        ...
                        name="contract-period"
                        className={checkboxClass}
                        checked={mockUserDetail?.data?.contractUpdateFlg === "無"}
                        disabled
                        readOnly
                      />
                      <label
                              ...
                              >
                                <div className="flex items-center">
                                  <input
                                    ...
                                    className={checkboxClass}
                                    checked={
                                      mockUserDetail?.data?.contractPlan
                ...
                <tr>
                  <td colSpan={5} className={tableClass}>
                    ...
                    <span>
                      ...
                      <span
                        className={
                          mockUserDetail?.data?.contractPlan?.introIncentive
                            ? "px-1 border ml-0.5"
                            : ""
                        }
                        style={{
                      ...
                      >
                        ...
                        >
                          {mockUserDetail?.data?.contractPlan?.introIncentive?.toLocaleString() ??
                            "0"}
                        </span>
                      </span>
                      円／1回）
                  ...
                  <td className={[tableClass, borderDownClass].join(" ")}>
                    <div className="flex items-center">
                      <input
                        ...
                        name="plan-7"
                        className={checkboxClass}
                        checked={mockUserDetail?.data?.depositType === ""}
                        disabled
                      />
                  ...
                  >
                    <div className="flex items-center">
                      <input
                        ...
                        className={checkboxClass}
                        checked={
                          mockUserDetail?.data?.depositType !== "" &&
                          mockUserDetail?.data?.deposite !== null
                        }
                        disabled
                        readOnly
                      />
                ...
                <tr>
                  ...
                  >
                    {/* 渡辺　太郎（ID:211223322） */}
                    {mockUserDetail?.data?.referrerId !== null
                      ? mockReferralUserDetail?.data?.user?.username +
                        "（ID:" +
                        mockReferralUserDetail?.data?.user?.userId +
                        "）"
                      : "-"}
                  </td>
                </tr>
            ...
            <table className={`w-full text-xs`} cellSpacing="0" cellPadding="0">
              <tbody>
                ...
                <tr>
                  ...
                  <td rowSpan={2}>
                    <div className="float-right" style={{ width: "150px" }}>
                      {mockUserDetail?.data?.signPath && (
                        // <ImageComponent
                        //   imgName="signature"
                        //   imgURL={getPublicUrl(userDetail?.data?.signPath) || ""}
                        //   className="w-[150px] h-auto object-contain"
                        // />
                      <p className="font-bold text-end">{mockUserDetail?.data?.signPath}</p>
                      )}
                    </div>
                  </td>
                </tr>
                ...
                <tr>
                  <td>＜連絡先＞電話番号 03-6661-2879（営業部：金本）</td>
                </tr>
              </tbody>
            </table>
          </div>
